...
<<<<<<< HEAD
	 ...
	 <div class="noprint">
		...
		<input type="button" value="Télécharger les Mentions Légale au format PDF" onclick="window.location='/assets/img/mentions_legale.pdf';">
	</div>
	
	<h1>I. CONDITIONS GÉNÉRALES D’UTILISATION</h1>

	<h3>ARTICLE 1. INFORMATIONS LÉGALES</h3>
		<p>En vertu de l’article 6 de la Loi n° 2004-575 du 21 juin 2004 pour la confiance dans l’économie numérique, il est précisé dans 
		cet article l’identité des différents intervenants dans le cadre de sa réalisation et de son suivi.
		Le site eLEGO est édité par : eLEGO, dont le siège social est situé à l’adresse suivante : Rue Gino Raimondi 54490 PIENNES.
		Téléphone : 03-12-34-56-78 Adresse e-mail : elego2016@gmail.com.
		Le directeur de publication du site est : eLEGO.
		Le site eLEGO est hébergé par : Elego , dont le siège est situé Rue Gino Raimondi
		Numéro de téléphone: 03-12-34-56-78</p>

	<h3>ARTICLE 2. PRÉSENTATION DU SITE</h3>
		<p>Le site eLEGO a pour objet :
		Site de vente en ligne de produit issu de la marque LEGO, le site propose une application en ligne qui permet aux utilisateurs de 
		créer leurs propre figurine qui pourront soit être commander grâce à la génération automatique d’un listing de pièces qui seront 
		utilisé dans la conception de la figurine, ce qui ramènera l’utilisateur a une page de commande en ligne ou plusieurs choix de 
		paiements lui seront proposé.</p>
	...
	<h3>ARTICLE 3. CONTACT</h3>
		...
		l’utilisateur peut contacter l’éditeur à l’adresse e-mail suivante: elego2016@gmail.com ou adresser un courrier recommandé avec 
		accusé de réception à : Rue gino Raimondi 54490 PIENNES</p>
	...
	<h3>ARTICLE 4. ACCEPTATION DES CONDITIONS D’UTILISATION</h3>
		...
		L’éditeur se réserve le droit de modifier, à tout moment et sans préavis, le site et des services ainsi que les présentes CGU, notamment 
		pour s’adapter aux évolutions du site par la mise à disposition de nouvelles fonctionnalités ou la suppression ou la modification de 
		fonctionnalités existantes.
		Il est donc conseillé à l’utilisateur de se référer avant toute navigation à la dernière version des CGU, accessible à tout moment 
		sur le site.En cas de désaccord avec les CGU, aucun usage du site ne saurait être effectué par l’utilisateur.</p>

	<h3>ARTICLE 5. ACCÈS ET NAVIGATION</h3>
		<p>L’éditeur met en œuvre les solutions techniques à sa disposition pour permettre l’accès au site 24 heures sur 24, 7 jours sur 7. Il pourra 
		néanmoins à tout moment suspendre,limiter ou interrompre l’accès au site ou à certaines pages de celui-ci afin de procéder à des mises à jour, 
		des modifications de son contenu ou toute autre action jugée nécessaire au bon fonctionnement du site.
		La connexion et la navigation sur le site eLEGO valent acceptation sans réserve des présentes Conditions Générales d’Utilisation, quelques 
		soient les moyens techniques d’accès et les terminaux utilisés.Les présentes CGU s’appliquent, en tant que de besoin, à toute déclinaison ou 
		extension du site sur les réseaux sociaux et/ou communautaires existants ou à venir.</p>
	...
	<h3>ARTICLE 7. SERVICES RÉSERVÉS AUX UTILISATEURS INSCRITS</h3>
		...
		<h4>7.1 INSCRIPTION</h4>
			<p>L’accès à certains services et notamment à tous les services payants, est conditionné par l’inscription de l’utilisateur.
			L’inscription et l’accès aux services du site sont réservés exclusivement aux personnes physiques capables juridiquement, ayant rempli et validé le formulaire d’inscription disponible en ligne sur le site eLEGO , ainsi que les présentes Conditions Générales d’Utilisation.
			...
			Toute communication réalisée par eLEGO et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l’utilisateur. Ce dernier s’engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.
			Une seule inscription aux services du site est admise par personne physique.
			L’utilisateur se voit attribuer un identifiant lui permettant d’accéder à un espace dont l’accès lui est réservé (ci-après « Mon compte »), en complément de la saisie de son mot de passe.
			...
			eLEGO se réserve en tout état de cause la possibilité de refuser une demande d’inscription aux services en cas de non-respect par l’Utilisateur des dispositions des présentes Conditions Générales d’Utilisation.</p>
	...
	<h3>ARTICLE 8. RESPONSABILITÉS</h3>
		...
		L’éditeur n’est pas responsable :</p>
		<ul>
		...
		<p>Par ailleurs, le site ne saurait garantir l’exactitude, la complétude, et l’actualité des informations qui y sont diffusées.
		L’utilisateur est responsable :</p>
			<ul>
	...
	<h3>ARTICLE 9. LIENS HYPERTEXTES</h3>
		<p>Le site peut contenir des liens hypertextes pointant vers d’autres sites internet sur lesquels eLEGO n’exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l’éditeur, celui-ci décline tout responsabilité quant aux contenus qu’il est possible de trouver sur ces sites.
		...
		Enfin, eLEGO se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l’estime non conforme à sa politique éditoriale.</p>
	
	<h3>ARTICLE 10. COLLECTE DE DONNÉES</h3>
		<p>Le site est déclaré à la Commission Nationale Informatique et Libertés (CNIL) sous le numéro 123 456
		...
		Pour faire usage de l’un des droits précités, l’utilisateur doit s’adresser à l’éditeur en le contactant par e-mail à l’adresse suivante : elego2016@gmail.com , ou par courrier recommandé adressé au siège social de l’éditeur en précisant ses nom, prénom(s), adresse et adresse(s) e-mail.</p>
	...
	<h3>ARTICLE 12. PROPRIÉTÉ INTELLECTUELLE</h3>
		<p>La structuration du site mais aussi les textes, graphiques, images, photographies, sons, vidéos et applications informatiques qui le composent sont la propriété de l’éditeur et sont protégés comme tels par les lois en vigueur au titre de la propriété intellectuelle.
		...
		L’accès au site ne vaut pas reconnaissance d’un droit et, de manière générale, ne confère aucun droit de propriété intellectuelle relatif à un élément du site, lesquels restes la propriété exclusive de l’éditeur.
		Il est interdit à l’utilisateur d’introduire des données sur le site qui modifieraient ou qui seraient susceptibles d’en modifier le contenu ou l’apparence.</p>
	...
	<hr>
	<h1>II. CONDITIONS GÉNÉRALES DE VENTE</h1>
		<h3>PREAMBULE</h3>

			<p>Le site est édité par le vendeur, eLEGO, dont le siège social est situé à l’adresse suivante : Rue Gino Raimondi 54490 PIENNES.
			Numéro individuel d’identification intracommunautaire du vendeur : 123 456 789
			Les dispositions suivantes ont pour objet de définir les conditions générales de vente sur le site eLEGO
			...
			Le vendeur se réserve le droit de modifier ponctuellement les CGV. Les modifications seront applicables dès leur mise en ligne.</p>
		...
		<h3>ARTICLE 1. CATALOGUE OU BOUTIQUE EN LIGNE</h3>
			...
			Les prix et les taxes afférentes à la vente des produits sont précisés dans le catalogue ou la boutique en ligne.</p>

		<h3>ARTICLE 2. PRIX</h3>
			<p>Le vendeur se réserve le droit de modifier ses prix à tout moment en les publiant en ligne.
			...
			Le paiement de la totalité du prix doit être réalisé lors de la commande.</p>
		...
		<h3>ARTICLE 3. COMMANDE EN LIGNE</h3>
			...
			Le vendeur se réserve le droit de bloquer la commande du client en cas de défaut de paiement, d’adresse erronée ou de tout autre problème sur le compte du client et ce, jusqu’à résolution du problème.</p>

		<h3>ARTICLE 4. CONFIRMATION ET PAIEMENT DE LA COMMANDE</h3>
			...
			<h4>4.1 PAIEMENT</h4>
				<p>Le client effectue le paiement au moment de la validation finale de la commande en spécifiant son numéro de carte bancaire.
				...
				Par téléphone au 03-12-34-56-78 ou par voie postal à eLEGO Rue Gino Raimondi 54490 PIENNES – Vous pouvez aussi nous faire part d’un email à l’adresse suivante : elego2016@gmail.com
				...
				Le vendeur se réserve également le droit de refuser une commande émanant d’un acheteur qui n’aurait pas réglé totalement ou partiellement une commande précédente ou avec lequel un litige de paiement serait en cours.</p>

			<h4>4.2 CONFIRMATION</h4>
			<p>Dès réception de la validation de l’achat et du paiement par le client, le vendeur transmet à ce dernier, sur l’adresse électronique qu’il a précisée, confirmation de la réception du bon de commande et un exemplaire du contrat à imprimer.
			...
			Par téléphone du Lundi au Samedi de 9h – 12h et de 14h – 19h Par Email elego2016@gmail.com Par voie postale : eLEGO – Rue Gino Raimondi – 54490 PIENNES France</p>

		<h3>ARTICLE 5. SIGNATURE ÉLECTRONIQUE</h3>
			<p>Conformément aux dispositions de la Loi n° 2000-230 du 13 mars 2000, la fourniture en ligne du numéro de carte bancaire de l’acheteur et la validation finale de la commande valent preuve de l’accord du client, de l’exigibilité des sommes dues au titre du bon de commande, signature et acceptation expresse de toutes les opérations effectuées.</p>

		<h3>ARTICLE 6. PREUVE DE LA TRANSACTION</h3>
		...
		<h3>ARTICLE 7. MODE DE PAIEMENT</h3>
		...
		<h3>ARTICLE 8. LIVRAISON</h3>
			...
			Livraison standard 3-6 jours selon conditions</p>

			<h4>8.1 RETARD DE LIVRAISON ET DÉNONCIATION</h4>
				<p>En cas de retard de livraison, le vendeur en informera le client, lequel peut dénoncer le contrat et demander à être remboursé dans les 14 jours à compter de cette dénonciation.
				...
				Par téléphone du Lundi au Samedi de 9h – 12h et de 14h – 19h Par Email elego2016@gmail.com Par voie postale : eLEGO – Rue Gino Raimondi – 54490 PIENNES France
				Toute dénonciation non effectuée dans les règles définies ci-dessus et dans les délais impartis ne pourra être prise en compte et dégagera le vendeur de toute responsabilité vis-à-vis du client.</p>

			<h4>8.2 VÉRIFICATION DE LA COMMANDE</h4>
				<p>Si au moment de la livraison, l’emballage d’origine est abîmé, déchiré, ouvert, le client doit alors vérifier l’état des produits. S’ils ont été endommagés, l’acheteur doit impérativement refuser le colis et noter une réserve sur le bon de livraison.
				...
				A la réception de la réclamation, le vendeur attribuera un numéro d’échange du ou des produit(s) concerné(s) et le communiquera par courrier électronique au client.</p>

			<h4>8.3 ERREUR DE LIVRAISON</h4>
				<p>En cas d’erreur de livraison et/ou de non-conformité des produits par rapport aux indications figurant sur le bon de commande, le client formule sa réclamation auprès du vendeur le jour même de la livraison ou au plus tard le premier jour ouvré suivant la livraison.
				La réclamation pourra être faite selon les modalités suivantes :
				Par téléphone du Lundi au Samedi de 9h – 12h et de 14h – 19h Par Email elego2016@gmail.com Par voie postale : eLEGO – Rue Gino Raimondi – 54490 PIENNES France
				Toute réclamation non effectuée dans les règles définies ci-dessus et dans les délais impartis ne pourra être prise en compte et dégagera le vendeur de toute responsabilité vis-à-vis du client.</p>

			<h4>8.4 RETOUR DE COMMANDE</h4>
				<p>Le produit à échanger ou à rembourser devra être retourné au vendeur dans son ensemble et dans son emballage d’origine, selon les modalités suivantes :
				Le produit pourra être retourné après accord de l’établissement d’un dossier constituer au prêt du Service Après-Vente. Dans un délai inférieur à 1 mois après la commande.
				...
				Tout produit à échanger ou à rembourser devra être retourné au vendeur dans son ensemble et dans son emballage d’origine. Les frais de retour sont à la charge du vendeur.</p>

		<h3>ARTICLE 9. GARANTIES DES PRODUITS</h3>
			...
			Il est indiqué au client que le vendeur n’est pas le producteur de la totalité des produits présentés au sens de la Loi n° 98-389 du 19 mai 1998 relative à la responsabilité du fait des produits défectueux.</p>

			<h4>9.1 GARANTIE DE CONFORMITÉ</h4>
				<p>Le client dispose d’un délai de 2 ans à compter de la délivrance du produit pour mettre en œuvre la garantie légale de conformité.
				...
				Le client n’est pas tenu de rapporter la preuve de l’existence d’un défaut de conformité, dans les 6 mois (24 mois à compter du 18 mars 2016, sauf pour les biens d’occasion) suivant la date de délivrance du produit.</p>

			<h4>9.2 GARANTIE DES VICES</h4>
				<p>Le client, s’il met en œuvre la garantie des vices prévue aux articles 1641 et suivants du Code civil, pourra choisir entre la résolution de la vente ou une réduction du prix, et ce conformément à l’article 1644 du Code civil.</p>

		<h3>ARTICLE 10. INDISPONIBILITÉ DES PRODUITS ET REMBOURSEMENT</h3>
			<p>En cas d’indisponibilité d’un produit commandé, le client en sera informé par courrier électronique.
			Le client aura la possibilité d’annuler sa commande et aura ainsi le choix entre le remboursement des sommes par lui versées dans les 30 jours au plus tard de leur versement, ou à l’échange du produit.</p>

		<h3>ARTICLE 11. DROIT DE RÉTRACTATION</h3>

		<p>Le client peut faire valoir son droit de rétractation et de retour du produit dans un délai de 14 jours ouvrables suivant la livraison.
		...
		Le client pourra demander l’échange ou le remboursement du produit retourné, sans pénalité, les frais de retour étant pris en charge par le vendeur.
		...
		Certains produits, en raison de leur qualité intrinsèque, ne pourront pas être soumis au droit de rétractation et ne pourront pas être remboursés, notamment mais pas exclusivement, les produits visés par l’article L. 121-21-8 du Code de la consommation à savoir :</p>
		<ul>
			<li>tout produit sur-mesure- tout produit ne pouvant pas par nature être réexpédié- tout produit périssable- tout produit vidéo- tout produit de presse- etc.</li>
		</ul>
		...
		<h3>ARTICLE 12. PROTECTION DES DONNÉES</h3>
			...
			<p>Le vendeur conservera dans ses systèmes informatiques et dans des conditions raisonnables de sécurité une preuve de la transaction comprenant le bon de commande et la facture.
			Le vendeur garantit son client de la protection des données personnelles de ce dernier.
			Le vendeur a fait à cet effet une déclaration à la CNIL sous le numéro 123 456
			...
			Par toute modification des informations personnel le client est prié de faire une demande par email à l’adresse suivante elego2016@gmail.com ou par voie postal à l’adresse suivante : eLEGO – Rue Gino Raimondi – 54490 PIENNES France. Aucune demande relative à ce sujet ne pourra être traitée par voie téléphonique.</p>

		<h3>ARTICLE 13. FORCE MAJEURE</h3>

			<p>Les parties seront exonérées de leurs obligations, dans le cas où une circonstance indépendante de leur volonté, constitutive d’un cas de force majeure, empêcherait leur exécution. Les obligations des parties seront suspendues.
		...
		<h3>ARTICLE 14. NULLITÉ PARTIELLE</h3>
		...
		<h3>ARTICLE 15. LOI APPLICABLE ET JURIDICTION COMPÉTENTE</h3>

			<p>Le vendeur est installé en France d’une manière stable et durable pour exercer effectivement son activité, quel que soit, s’agissant d’une personne morale, le lieu d’implantation de son siège social.
