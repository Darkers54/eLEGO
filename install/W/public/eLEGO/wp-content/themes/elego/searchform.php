...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo __( 'Recherche...', 'i-craft' ) ?>" value="<?php echo esc_attr(get_search_query()) ?>" name="s" title="<?php echo __( 'Search for:', 'i-craft' ) ?>" />
	</label>
